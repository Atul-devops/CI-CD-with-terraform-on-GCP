...
resource "google_service_account" "sa" {
  ...
  display_name = "A Service Account email to access "
...
resource "google_cloudbuild_trigger" "cloud_build_trigger" {
  ...
  depends_on = [google_project_service.build, google_sourc#  Creating Service Account
#   - Enable API
#   - Create SAerepo_repository.repo]
}
